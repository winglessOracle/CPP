...
/*   Updated: 2023/07/14 12:36:12 by cwesseli      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
//post: store the current value, modify it and retunr the stored value.
...
// non clasas ostream overload
std::ostream& operator<< (std::ostream& output, const Fixed& rhs) {
	output << rhs.toFloat();
	return output;
}
/*
check negative numbers and other input stuff (signed or not)
*/